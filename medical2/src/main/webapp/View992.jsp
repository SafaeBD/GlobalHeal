...
<body>
    ...
    <div class="sidebar">
        ...
        <div class="separator"></div>
        <button class="button" onclick="showPatientList()">Get Patient List</button>
        <div class="separator"></div>
        <button class="button">Recommend Treatments</button>
        <div class="separator"></div>
        <button class="button">Get Appointments List</button>
        <div class="separator"></div>
        <button class="button">Patient List</button>
        <div class="separator"></div>
        <button class="button" onclick="showLogoutQuestion()">Logout</button>
    ...
    <div class="image-container">
        ...
        <div class="overlay" id="logoutQuestionOverlay">
            ...
            <div class="button-container">
                ...
                <button onclick="hideLogoutQuestion()">Cancel</button>
            </div>
        </div>
    </div>
    ...
    <script>
        function showPatientList() {
            // Ajoutez la logique pour afficher la liste des patients ici
        }
